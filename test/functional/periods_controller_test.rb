...
class PeriodsControllerTest < ActionController::TestCase
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post :create, period: { duration: @period.duration, finished: @period.finished, started_at: @period.started_at }
    end
  ...
  test "should update period" do
    put :update, id: @period, period: { duration: @period.duration, finished: @period.finished, started_at: @period.started_at }
    assert_redirected_to period_path(assigns(:period))
  end
